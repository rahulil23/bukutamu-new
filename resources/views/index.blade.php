...
<body>
    <form id="myForm" action="{{ url ('/simpan-bukutamu')}}" method="POST" autocomplete="off" name="formInput">
        ...
        <div class="tab" id="tab-1">
            ...
            <div class="input-group">
                ...
                <input type="text" name="name" id="name" placeholder="Silahkan isi nama anda" maxlength="30"
                    ...
                    data-parsley-pattern="/(^[a-zA-Z][a-zA-Z\s]{0,30}[a-zA-Z]$)/" data-parsley-trigger="keyup"
                    required />
                {{-- @error('name')
            ...
            <div class="input-group">
                ...
                <input type="text" name="hp" id="hp" class="form-control" placeholder="Silahkan isi no handphone anda"
                    minlength="8" maxlength="13" value="{{old('hp')}}" data-parsley-type="integer"
            ...
            <div class="form-group mb-3">
                ...
                <select class="custom-select my-1 mr-sm-2" name="gender" id="gender" value={{collect(old('gender'))}}
                    required>
            ...
            <div class="input-group">
                ...
                <input type="text" name="address" id="address" class="form-control"
                    placeholder="Silahkan isi alamat anda" maxlength="50" value="{{old('address')}}"
                    data-parsley-trigger="keyup" required />
            </div>
            ...
            <div class="input-group">
                ...
                <input type="text" name="age" id="age" class="form-control"
                    placeholder="Silahkan isi umur anda (contoh: 27)" maxlength="3" value="{{old('age')}}"
                    onkeypress="return event.charCode >= 48 && event.charCode <=57" data-parsley-type="integer"
                    data-parsley-trigger="keyup" required />
                {{-- @error('age')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror --}}
        ...
        <div class="tab" id="tab-2">
            ...
            <div class="input-group">
                ...
                <input type="text" name="institute" id="institute" class="form-control"
                    ...
                    data-parsley-pattern="/(^[a-zA-Z][a-zA-Z\s]{0,35}[a-zA-Z]$)/" data-parsley-trigger="keyup"
                    required />
                {{-- @error('institute')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror --}}
            ...
            <div class="input-group">
                ...
                <input type="text" name="nipnim" id="nipnim" class="form-control"
                    placeholder="Silahkan isi nip/nim anda" maxlength="20" value="{{old('nipnim')}}"
                    onkeypress="return event.charCode >= 48 && event.charCode <=57" data-parsley-type="integer"
                    data-parsley-trigger="keyup" required />
                {{-- @error('nipnim')
                <div class="alert alert-danger">{{ $message }}</div>
        ...
        <div class="tab" id="tab-3">
            ...
            <div class="input-group">
                <div class="form-group mb-3">
                    ...
                    <select class="custom-select my-1 mr-sm-2" name="service" id="service" required>
                        <option selected disabled>Silahkan Pilih Jenis Pelayanan</option>
            ...
            <div class="input-group">
                <div class="form-group mb-3">
                    <label class="label" for="media" style="color:#000000">Kebutuhan </label>
                    <select class="custom-select my-1 mr-sm-2" name="sub_categories" id="sub_categories" required
                        disabled>
                        <option selected disabled>Silahkan Pilih Kebutuhan </option>
                    </select>
                </div>
            </div>
        ...
        <div class="tab" id="tab-4">
            ...
            <div class="input-group">
                <label for="data" style="color:#000000">Keterangan</label>
                <textarea type="text" name="data" id="data" placeholder="Silahkan isi keperluan spesifik yang anda perlukan"
                    class="form-control" rows="10" cols="55" maxlength="50" value="{{old('data')}}"
                    onkeypress="return event.charCode < 48 || event.charCode>57" data-parsley-trigger="keyup"
                    required></textarea>
            </div>
...
document.getElementById('service').addEventListener('change', function() {
  ...
  var subCategoriesSelect = document.getElementById('sub_categories');
  subCategoriesSelect.innerHTML = '<option selected disabled>Silahkan Pilih Kebutuhan </option>';

  if (selectedService !== '') {
    var selectedCategories = categories.filter(function(category) {
      return category.id_service == selectedService;
    });

    selectedCategories.forEach(function(category) {
      var optgroup = document.createElement('optgroup');
      optgroup.label = category.categories_type;

      category.guest_sub_category.forEach(function(subCategory) {
        var option = document.createElement('option');
        option.value = subCategory.id;
        option.textContent = subCategory.sub_categories_type;
