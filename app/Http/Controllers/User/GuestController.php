...
class GuestController extends Controller
{
    public function formTamu() {
        ...
        $categories = Category::with(['guestSubCategory' => function ($query) use ($sub_categories) {
            $query->whereIn('id', $sub_categories->pluck('id'));
        }])->whereIn('id_service', $service->pluck('id'))->get();
